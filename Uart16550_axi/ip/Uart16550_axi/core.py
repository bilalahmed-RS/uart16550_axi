...
class RTL2UART(Module, AutoDoc, AutoCSR):
    ...
    def __init__(self, platform, pads, default_enable=0):
        ...
        platform.add_source("/home/users/bilal.ahmed/dev_litex/pythondata_ip_uart16550/pythondata_ip_uart16550/verilog/timescale.v")
        platform.add_source("/home/users/bilal.ahmed/dev_litex/pythondata_ip_uart16550/pythondata_ip_uart16550/verilog/uart_defines.v")
        platform.add_source_dir(path="/home/users/bilal.ahmed/dev_litex/pythondata_ip_uart16550/pythondata_ip_uart16550/verilog/")
